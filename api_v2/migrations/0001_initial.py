# Generated by Django 3.2.20 on 2023-08-13 08:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('name', models.CharField(help_text='Name of the item.', max_length=100)),
                ('key', models.CharField(help_text='Unique key for the localized content.', max_length=100, primary_key=True, serialize=False)),
                ('lang', models.TextField(help_text='What language this content is written in, e.g., "en" or "fr".')),
                ('weapon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_v2.weapon')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(help_text='Unique key for the localized content.', max_length=100, primary_key=True, serialize=False)),
                ('lang', models.TextField(help_text='What language this content is written in, e.g., "en" or "fr".')),
                ('armor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_v2.armor')),
            ],
            options={
                'abstract': False,
            },
